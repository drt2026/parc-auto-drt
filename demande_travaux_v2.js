...
(function () {
    ...
    function renderCarburantTable(search) {
      ...
      tbody.innerHTML = list.map(function(e) {
        ...
        return '<tr>' +
          ...
          '<td><button type="button" class="tr4-del-btn" data-mat="' + (e.matricule||'') + '" data-mois="' + (e.mois||'') + '" title="Supprimer cette saisie" style="background:#FEE2E2;color:#991b1b;border:none;border-radius:8px;padding:6px 10px;font-size:12px;font-weight:700;cursor:pointer;white-space:nowrap;font-family:inherit">🗑️ Supprimer</button></td>' +
          '</tr>';
      }).join('');
  ...
  function initValidateurInterface() {
      ...
      <div id="tr2v-modal" role="dialog" aria-modal="true" aria-label="Interface Validateur">
        ...
        <div id="tr2v-sc-carburant" style="display:none">
          ...
          <div class="tr2v-bd">
            ...
            <div class="tr2-table-wrap" style="overflow-x:auto">
              <table class="tr2-table" style="min-width:1100px">
                <thead>
                  <tr>
                    <th>Mois</th><th>Matricule</th><th>Marque</th><th>Qté Début</th><th>Index Début</th>
                    <th>Qté Fin</th><th>Index Fin</th><th>Ravitaillement (DT)</th><th>Solde Carte (DT)</th>
                    <th>Distance</th><th>Observations</th><th>Saisi par</th><th>Date saisie</th>
                  </tr>
                </thead>
    ...
    function renderCarburantTableV(search) {
      ...
      if (!list.length) {
        tbody.innerHTML = '<tr><td colspan="13" style="text-align:center;color:#94a3b8;padding:20px">Aucune saisie pour le moment.</td></tr>';
        return;
      }
      tbody.innerHTML = list.map(function(e) {
        var marque = getMarqueFromMat(e.matricule) || '';
