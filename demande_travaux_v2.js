...
(function () {
  ...
  function initSuiviCarburantModal() {
    ...
    css.textContent = `
      ...
      #tr3-modal { background:#fff; border-radius:20px; width:min(1180px,97vw);
        max-height:95vh; overflow-y:auto;
        box-shadow:0 24px 64px rgba(0,0,0,0.22);
        animation:tr2Up .28s cubic-bezier(.22,1,.36,1); }
      #tr3-table-wrap table { width:100%; border-collapse:collapse; font-size:14.5px; margin:10px 0; }
      #tr3-table-wrap thead tr { background:#1F3864; color:#fff; }
      #tr3-table-wrap th { padding:11px 10px; text-align:left; font-weight:600; }
      #tr3-table-wrap td { padding:9px 8px; border-bottom:1px solid #e2e8f0; }
      #tr3-table-wrap td input[type=number] { width:110px; padding:9px 10px; border:1.5px solid #e2e8f0;
        border-radius:8px; font-size:14.5px; font-family:inherit; }
      #tr3-table-wrap td input[type=text] { width:170px; padding:9px 10px; border:1.5px solid #e2e8f0;
        border-radius:8px; font-size:14.5px; font-family:inherit; }
    ...
    function renderTable(nom, mois) {
      ...
      wrap.innerHTML = '<div style="overflow-x:auto"><table style="min-width:1340px"><thead><tr>' +
