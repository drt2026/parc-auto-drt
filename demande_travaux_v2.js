...
(function () {
  ...
  // BLOC CORRECTIF — "Diesel" n'était pas reconnu (seul "Gasoil" l'était), ce qui
  // laissait le Prix du Litre vide pour tout véhicule dont l'énergie est "Diesel" →
  // Quantité Consommée et Taux Consommation tombaient à 0 dans l'export. Impact réel
  // mesuré : 44 véhicules sur 65 (68% du parc) étaient concernés. Ajout des synonymes
  // courants (Diesel, Gazole) en plus des libellés déjà gérés.
  var TR3_PRIX_LITRE_DEFAUT = {
    'GASOIL': 2.205,
    'DIESEL': 2.205,
    'GAZOLE': 2.205,
    'GASOIL SANS SOUFRE': 2.205,
    'DIESEL SANS SOUFRE': 2.205,
    'SUPER SP': 2.525,
    'SUPER': 2.525,
    'ESSENCE': 2.525,
    'SANS PLOMB': 2.525
