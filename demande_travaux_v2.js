...
(function () {
  ...
  function initValidateurInterface() {
          ...
          <div class="tr2v-bd">
            <div class="tr2v-user-bar">
              ...
              <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">
                ...
                <button class="tr2v-logout" id="tr2v-carburant-export-btn" style="background:#FFE8D6;color:#9a4a13">⛽ Carburant</button>
    ...
    // BLOC ADDITIF — Export Suivi Carburant (Validateur : ZO-VALID-2026 / HF-VALID-2026)
    // Même format "Consommation Carburants" (.xlsx, un onglet par mois) que côté admin
    document.getElementById('tr2v-carburant-export-btn').addEventListener('click', function() {
      var data = getData();
      var list = (data && data.suiviCarburant) ? data.suiviCarburant : [];
