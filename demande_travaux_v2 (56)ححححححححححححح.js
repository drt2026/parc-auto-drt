...
(function () {
  ...
  function initSuiviCarburantModal() {
    ...
    function renderTable(nom, mois) {
      ...
      wrap.innerHTML = '<div style="overflow-x:auto"><table style="min-width:1220px"><thead><tr>' +
        '<th>Matricule</th><th>Marque</th><th>Qté Début</th><th>Ravitaillement (DT)</th><th>Qté Fin</th>' +
        '<th>Index Début</th><th>Index Fin</th><th>Solde Carte (DT)</th><th>Distance</th><th>Observations</th>' +
      ...
      tabEl.innerHTML = `
        ...
        <div class="tr2-table-wrap" style="overflow-x:auto">
          <table class="tr2-table" style="min-width:1100px">
            <thead>
              <tr>
                <th>Mois</th><th>Matricule</th><th>Marque</th><th>Qté Début</th><th>Ravitaillement (DT)</th>
                <th>Qté Fin</th><th>Index Début</th><th>Index Fin</th><th>Solde Carte (DT)</th>
  ...
  function initValidateurInterface() {
    ...
    ov.innerHTML = `
      <div id="tr2v-modal" role="dialog" aria-modal="true" aria-label="Interface Validateur">
          ...
          <div class="tr2v-bd">
            <div class="tr2v-user-bar">
              ...
              <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">
                ...
                <button class="tr2v-logout" id="tr2v-carburant-export-btn" style="background:#FFE8D6;color:#9a4a13">⛽ Suivi Carburant</button>
        ...
        <div id="tr2v-sc-carburant" style="display:none">
          ...
          <div class="tr2v-bd">
            <div class="tr2v-hist-back-bar">
              <button class="tr2v-hist-back-btn" id="tr2v-carb-back-btn">⬅️ Retour aux demandes en attente</button>
    ...
    document.getElementById('tr2v-carburant-export-btn').addEventListener('click', function() {
      vScreen('carburant');
