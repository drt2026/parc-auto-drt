/* ============================================
   ...
   STOCKAGE INDEPENDANT + SYNCHRONISATION CLOUD
   ============================================ */
...
const JSONBIN_CONFIG = {
  ...
  BIN_ID: '6a1b534221f9ee59d29efd76',
  BASE_URL: 'https://api.jsonbin.io/v3/b'
};

// ============================================
// CLE DE STOCKAGE v3 (INDEPENDANT)
// ============================================
const STORAGE_KEY = 'parcAutoData_v3';
...
class ParcAutoApp {
  ...
  async writeToCloud() {
    ...
    try {
      ...
      if (!response.ok) {
        console.warn('Erreur ecriture cloud:', response.status, response.statusText);
        return false;
      }
  ...
  async saveVehicle() {
    ...
    // Validation: km must be reasonable (0 - 999,999)
    if (kmVal > 999999) {
      ...
      <div class="vehicle-detail-card">
        ...
        <div class="vehicle-detail-body">
          ...
          <div style="text-align:center;padding-top:16px;border-top:1px solid var(--border);margin-top:16px;">
            <p style="font-size:12px;color:var(--secondary);">Donnees synchronisees avec le cloud • Mise a jour automatique</p>
          </div>
        </div>
      </div>
    `;
