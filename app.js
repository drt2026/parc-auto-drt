...
class ParcAutoApp {
  ...
  initUserLogin() {
    ...
    form.addEventListener('submit', async (e) => {
      ...
      const dbAgentMat = String(vehicle.matriculeAgent || '').toUpperCase().replace(/[\s-]/g, '').trim();
      ...
      if (dbAgentMat !== inputAgentMat) {
        ...
        this.showToast('Matricule agent incorrect. Attendu: ' + (vehicle.matriculeAgent || 'NON DÉFINI') + ' | Saisi: ' + agentInput, 'error');
        return;
      }
