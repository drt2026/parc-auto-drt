...
// ============================================
function showOTPScreen(vehicleData) {
  ...
  overlay.innerHTML = `
    <div style="background:#fff;border-radius:24px;padding:36px 28px;max-width:400px;width:100%;text-align:center;box-shadow:0 32px 80px rgba(0,0,0,0.3);animation:otpFadeIn .3s ease;">
      ...
      <p style="font-size:13px;color:#64748b;line-height:1.6;margin-bottom:4px;">
        Un code OTP à 6 chiffres a été envoyé par email à l'adresse<br>du Chef de Parc.
      </p>
      <p style="font-size:13px;font-weight:600;color:#1e293b;margin-bottom:20px;">Consultez votre email pour récupérer le code.</p>
