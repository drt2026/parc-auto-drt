...
class ParcAutoApp {
  ...
  initUserLogin() {
    ...
    form.addEventListener('submit', (e) => {
      ...
      // Chercher le véhicule par matricule (insensible à la casse et aux espaces)
  ...
  saveRepair() {
    ...
    // Mettre à jour le véhicule automatiquement
    if (vehicle) {
      ...
      <div class="vehicle-detail-card">
        ...
        <div class="vehicle-detail-body">
          ...
          <div style="text-align:center;padding-top:16px;border-top:1px solid var(--border);margin-top:16px;">
            <p style="font-size:12px;color:var(--secondary);">Les données sont synchronisées automatiquement avec l'administration</p>
          </div>
        </div>
      </div>
    `;
  ...
  syncNow() {
    ...
    setTimeout(() => {
      ...
      // Si on est sur l'interface utilisateur, rafraîchir aussi
