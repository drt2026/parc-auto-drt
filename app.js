...
class ParcAutoApp {
  ...
  initUserLogin() {
    ...
    form.addEventListener('submit', async (e) => {
      ...
      const agentInput = document.getElementById('user-matricule-agent')?.value.trim().toUpperCase();
      const vehicleInput = document.getElementById('user-matricule-vehicle')?.value.trim().toUpperCase();
