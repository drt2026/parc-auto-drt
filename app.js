...
function exportCSV() {
  ...
  const headers = ['Matricule','Modèle','Chauffeur','KM Actuel','Prochaine Vidange','Prochaine Chaîne','Prochaine Visite','Date Batterie','Indice Batterie','Date Pneus','Statut','Constructeur','Type Commercial','N° Série (Châssis)','1ère Mise en Circulation','Genre','Énergie'];
