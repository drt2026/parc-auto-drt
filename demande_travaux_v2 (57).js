...
(function () {
  ...
  function initSuiviCarburantModal() {
    ...
    function renderTable(nom, mois) {
      ...
      wrap.innerHTML = '<div style="overflow-x:auto"><table style="min-width:1220px"><thead><tr>' +
        '<th>Matricule</th><th>Marque</th><th>Qté Début</th><th>Index Début</th><th>Qté Fin</th>' +
        '<th>Index Fin</th><th>Ravitaillement (DT)</th><th>Solde Carte (DT)</th><th>Distance</th><th>Observations</th>' +
  ...
  function initSuiviCarburantAdminTab() {
    ...
    var TR4_MOIS_ABBR = {
      'janv': '01', 'jan': '01', 'fev': '02', 'févr': '02', 'fevr': '02', 'mars': '03',
        ...
        ensureXLSXReadLib(function() {
          try {
            ...
            wb.SheetNames.forEach(function(sheetName) {
              var mois = parseSheetNameToMois(sheetName);
              if (!mois) return; // ignore "Synthèse Annuelle" et tout onglet non reconnu
              ...
              if (iImmat === -1) return; // onglet non reconnu, on l'ignore silencieusement
              var iQteDeb = findCol(headerRow, /quantit.*d.but/i);
              var iIdxDeb = findCol(headerRow, /index.*d.but/i);
              var iQteFin = findCol(headerRow, /quantit.*fin/i);
              ...
              for (var r = 1; r < rows.length; r++) {
                ...
                var ravitaillement = iRavit !== -1 ? num(row[iRavit]) : null;
            ...
            if (status) {
              status.textContent = monthsDone
                ...
                : '❌ Aucun onglet mensuel reconnu dans ce fichier (attendu : Janv26, Fev26, …).';
            }
            renderCarburantTable(document.getElementById('tr4-search') ? document.getElementById('tr4-search').value : '');
