...
(function () {
  ...
  const TRAVAUX_USER_INFO = {
    ...
    'Mongia Mekki':         { division: 'DAF',                             subdivision: 'Division des moyens' },
  ...
  const VALIDATEUR_TITRES = {
    'Mongia Mekki':      'Chef Division des Moyens',
  ...
  function initValidateurInterface() {
    ...
    // BLOC ADDITIF — Onglet Suivi Carburant (Validateur : ZO-VALID-2026 / MM-VALID-2026)
