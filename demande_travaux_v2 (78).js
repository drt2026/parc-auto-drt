...
(function () {
  ...
  function initSuiviCarburantModal() {
    ...
    css.textContent = `
      ...
      #tr3-table-wrap .tr3-save-row-btn, #tr3-table-wrap .tr3-cancel-row-btn {
      ...
      /* BLOC ADDITIF — boutons Enregistrer/Annuler affichés pendant l'édition d'une ligne */
      #tr3-table-wrap .tr3-save-row-btn { background:#DCFCE7; color:#15803d; }
      #tr3-table-wrap .tr3-save-row-btn:hover { background:#BBF7D0; }
      #tr3-table-wrap .tr3-cancel-row-btn { background:#F1F5F9; color:#475569; }
      #tr3-table-wrap .tr3-cancel-row-btn:hover { background:#E2E8F0; }
      /* FIN BLOC ADDITIF */
      /* FIN BLOC ADDITIF */
      @media(max-width:700px){
        ...
        /* BLOC ADDITIF */
        #tr3-table-wrap .tr3-edit-btn, #tr3-table-wrap .tr3-del-btn,
        #tr3-table-wrap .tr3-save-row-btn, #tr3-table-wrap .tr3-cancel-row-btn { display:block; width:100%; margin:3px 0; }
        /* FIN BLOC ADDITIF */
      }
      /* FIN BLOC ADDITIF */
    `;
    ...
    function renderTable(nom, mois) {
      ...
      wrap.querySelectorAll('.tr3-edit-btn').forEach(function(btn) {
        btn.addEventListener('click', function() {
          ...
          // BLOC CORRECTIF — l'ancien code affichait un simple texte statique
          // "Modification en cours…" sans aucun bouton pour valider ou annuler,
          // ce qui donnait l'impression que le bouton "Modifier" restait bloqué
          // sans réponse (l'utilisateur devait deviner qu'il fallait cliquer sur
          // "Enregistrer" tout en bas du formulaire). On ajoute maintenant deux
          // vrais boutons directement sur la ligne : Enregistrer déclenche la
          // sauvegarde normale (#tr3-save-btn) ; Annuler restaure la ligne verrouillée.
          if (actionsCell) {
            actionsCell.innerHTML =
              '<button type="button" class="tr3-save-row-btn" title="Enregistrer la modification">💾 Enregistrer</button>' +
              '<button type="button" class="tr3-cancel-row-btn" title="Annuler la modification">✖ Annuler</button>';
            var saveRowBtn = actionsCell.querySelector('.tr3-save-row-btn');
            var cancelRowBtn = actionsCell.querySelector('.tr3-cancel-row-btn');
            if (saveRowBtn) {
              saveRowBtn.addEventListener('click', function() {
                var mainSaveBtn = document.getElementById('tr3-save-btn');
